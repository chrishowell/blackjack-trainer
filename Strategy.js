 ...
 *   - decks/bet/hint/scrollMiss  used by the app only (not strategy)
 * ============================================================ */
(function (root, factory) {
  ...
  const DEFAULT_RULES = { h17:false, das:true, surrender:false, decks:6, bet:10, hint:true, scrollMiss:true };
